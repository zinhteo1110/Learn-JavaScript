...
function split(type,capacity) {
	type.splice(0,capacity);
}
...
// Viet ham cat 10 phan tu cua mang
function split_array (arraynums,num_print) {
	for (var i = 0; i < arraynums.length; i++) {
		var sub_arraynums = arraynums.splice(0,num_print);                                           
	}
}
