...
elements.configForm.addEventListener('submit', function (e) {
  ...
  config.authorizationUser = form[0].value;
  config.password = form[1].value
  config.displayName = form[0].value;
  config.uri = form[0].value + "@freeswitch.ddns.net:5060";
  ...
  ua.on('connected', function () {
    elements.uaStatus.innerHTML = '1.Connected (Unregistered)';
  });

  ua.on('registered', function () {
    elements.registerButton.innerHTML = 'Unregister';
    elements.uaStatus.innerHTML = '2.Connected (Registered)';
  });

  ua.on('unregistered', function () {
    elements.registerButton.innerHTML = 'Register';
    elements.uaStatus.innerHTML = '3.Connected (Unregistered)';
  });
